...
# Title: Downlink
# Generated: Fri Aug 24 19:16:02 2018
...
class downlink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Downlink")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Downlink")
        ...
        self.top_grid_layout.addWidget(self.tab, 0, 0, 12, 1)
        for r in range(0, 12):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._noise_volt_range = Range(0, 0.1, 0.001, 0.0001, 200)
        self._noise_volt_win = RangeWidget(self._noise_volt_range, self.set_noise_volt, 'Noise Voltage', "counter_slider", float)
        self.top_grid_layout.addWidget(self._noise_volt_win, 6, 1, 1, 1)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._frequency_offset_win, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._decimation_tool_bar, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._alpha_win, 5, 1, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_waterfall_sink_x_1_win)
        ...
        self.tab_grid_layout_4.addWidget(self._qtgui_freq_sink_x_0_0_win)
        ...
        self.tab_grid_layout_3.addWidget(self._qtgui_const_sink_x_0_win)
        self.kiss_nrzi_decode_0 = gr_kiss.nrzi_decode()
        self.kiss_hdlc_deframer_0 = gr_kiss.hdlc_deframer(check_fcs=True, trim_fcs=True, max_length=10000)
        ...
        self.frame_sink_1 = gr_kiss.frame_sink('tcp://*:7001')
        ...
        self.connect((self.fractional_resampler_xx_0, 0), (self.digital_costas_loop_cc_0, 0))
